    ...
    case 's':
      {
        ...
        }else if(!strcmp("sequential_timsort", arg)){
          args->chosen_sort = sequential_timsort;
        }else if(!strcmp("gfx_timsort", arg)){
          args->chosen_sort = gfx_timsort;
        }else if(!strcmp("tvs_timsort", arg)){
          args->chosen_sort = tvs_timsort;
